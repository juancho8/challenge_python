...
lista = ['juancho','pepe','manolo','pablo']
print("\tWelcome to the Shipping Accounts Program")
#Pediremos el nombre de usuario y comprobamos si esta en la lista .
name = input("\nHello, what is your username: ").lower()

if name in lista:
    print("\nHello ",name,". Welcome back to your account.")
    print("Current shipping prices are as follows:")
    print("Shipping orders 0 to 100:\n$5.10 each")
    print("Shipping orders 100 to 500:\n$5.00 each")
    print("Shipping orders 500 to 1000:\t$4.95 each")
    print("Shipping orders over 1000:\t$4.80 each")
    # hacemos print de los valores
...
# este else es por si el usuario nos dice que algo incorrecto
else:
