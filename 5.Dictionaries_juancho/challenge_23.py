...
# las tres variables se explican por si solas 
# 1 vatoacion / 2 cantidad / 3 resultados 
...
for i in range(v):
    # un bucle for es clave para poder reutilizar el bloque de codigo y que no se ejecute solo una vez
