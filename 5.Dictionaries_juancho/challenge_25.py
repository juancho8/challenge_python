...
# Un objeto Counter es un contenedor del módulo collections que se utiliza para contar las veces que aparece un valor
#  en una secuencia de caracteres, en una lista, un diccionario o una lista de nombres de argumentos con asignaciones
