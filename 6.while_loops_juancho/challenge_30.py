...
#para saber la variable de el usuario y su porcentaje de acierto
...
while carton:
    # queremos saber la cantidad de opciones que tiene el ususario 
    nums = []
